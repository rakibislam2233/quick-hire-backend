...
export const uploadImageToCloudinary = async (
  buffer: Buffer,
  folder: string = 'quick-hire/images'
): Promise<{ url: string; public_id: string }> => {
...
export const uploadDocumentToCloudinary = async (
  buffer: Buffer,
  folder: string = 'quick-hire/documents'
): Promise<{ url: string; public_id: string }> => {
  return await uploadBufferToCloudinary(buffer, folder);
};
...
export const uploadProfileImage = async (
  ...
  const folder = 'quick-hire/profiles';
...
export const uploadCRDocumentProof = async (
  ...
  const folder = 'quick-hire/cr-documents';
...
export const uploadInstitutionLogo = async (
  ...
  const folder = 'quick-hire/institutions';
